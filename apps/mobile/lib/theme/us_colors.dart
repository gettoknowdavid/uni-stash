...
// // ---------------------------------------------------------------------------
// // UsColorTokens — extra semantic tokens not covered by ShadColorScheme
// // ---------------------------------------------------------------------------

// /// Provides convenient access via `context.theme.us.colors`.
// @immutable
// class UsColorTokens extends ThemeExtension<UsColorTokens> {
//   const UsColorTokens({
//     // ── Text Roles ────────────────────────────────────────────────────────
...
//   @override
//   UsColorTokens lerp(covariant UsColorTokens? other, double t) {
//     if (other is! UsColorTokens) return this;
//     return UsColorTokens(
