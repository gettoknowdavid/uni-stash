...
import 'package:uni_stash_mobile/features/blocks/pages/blocked_users_page.dart';
...
import 'package:uni_stash_mobile/features/notifications/pages/notifications_page.dart';
...
final GoRouter routerConfig = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: UsRoutes.notifications,
      builder: (context, state) => const NotificationsPage(),
    ),
    GoRoute(
      path: UsRoutes.blockedUsers,
